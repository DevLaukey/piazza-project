...
const authConfig = {
  ...
  domain: 'https://dev-fb3fqap2.us.auth0.com'
};
...
const registerUser = async (req, res) => {
  try {
    ...
    try {
      ...
      return res.status(500).json({ message: 'Internal Server Error - User creation failed' });
    }

    // Register user in Auth0
    await axios.post(
      `${authConfig.baseURL}/users`,
      {
        email: username,
        password,
